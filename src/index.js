    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error("Error calling API: ".concat(error_1.message));
                    return [3 /*break*/, 3];
...
function startMonitoring(configPath) {
    var config = readConfigFile(configPath);
    console.log("Monitoring API at ".concat(config.endpoint, " every ").concat(config.interval / 1000, " seconds"));
    console.log(config);
